...
def trends():
    data = [
        'Deceptive Practice', 'Narcotics', 'Burglary', 'Criminal Damage',
        'Kidnapping', 'Prostitution', 'Human Trafficking', 'Robbery',
        'Crim Sexual Assault', 'Assault', 'Battery Homicide',
        'Motor Vehicle Theft', 'Theft', 'Offense Involving Children',
        'Weapons Violation'
    ]
    if request.method == 'POST':
